                    ...
                    <div className="delivery_content">
                      ...
                      >
                        <div className="deliver_text">
                          ...
                          <p>
                            This carrier delivers in 1-2 working day <br />{" "}
                            (expected delivery in the next 24-48 hours because
                            of Covid-19)
                          </p>
                        </div>
                        <Field
                      ...
                      >
                        <div className="deliver_text">
                          <h3>Ninja Van</h3>
                          <p>
                            This carrier delivers in 2-3 working day <br />{" "}
                            (expected delivery in the next 48-72 hours because
                            of Covid-19)
                          </p>
                        </div>
                        <Field
                      ...
                      >
                        <div className="deliver_text">
                          ...
                          <p>
                            This carrier delivers in 3-4 working day <br />{" "}
                            (expected delivery in the next 48-96 hours because
                            of Covid-19)
                          </p>
                        </div>
                        <Field
                ...
                <div className="checkout_help">
                  ...
                  <div className="help_content">
                    ...
                    >
                      ...
                      >
                        <p>
                          To guarantee the best experience of receiving our
                          product, the package you will receive will not show
                          anything on the outside that could reveal its
                          contents, in order to avoid generating interest from
                          third or malicious parties.
                        </p>
                      </div>
                    </div>
                  </div>
